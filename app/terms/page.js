    ...
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "2rem", fontFamily: "sans-serif", lineHeight: "1.6", color: "#333" }}>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ marginTop: "1rem" }}>
          通信は全て暗号化（SSL/TLS）されており、第三者が内容を覗き見ることはできません。また、<strong>使用者のブラウザとAI基盤の中間はデータを一切保持しない</strong>構成（ステートレス）であるため、情報がサーバーに残存・蓄積されるリスクを構造的に排除しています。
        </p>
        <p style={{ marginTop: "1rem" }}>
